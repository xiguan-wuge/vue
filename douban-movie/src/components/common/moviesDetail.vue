        ...
        <div class="left-side">
          <div class="actor-list">
            <div class="subject">   
              ...
              <div class="info">
                <span class="p1">导演: </span><span v-for="(item, index) in movieDetail.directors" :key="index" class="attrs">{{item.name}}</span><br>
                <span class="p1">主演: </span><span v-for="(item, index) in movieDetail.casts" :key="index" class="attrs">{{item.name}}/</span><br>
                <span class="p1">类型: </span><span v-for="(item, index) in movieDetail.genres" :key="index" class="attrs">{{item}}/</span><br>
                <span class="p1">制片国家/地区: </span><span v-for="(item,index) in movieDetail.countries" :key="index" class="attrs">{{item}}</span><br>

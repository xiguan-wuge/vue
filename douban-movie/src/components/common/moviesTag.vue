<template>
  <div class="moviesList" v-loading="loadingMoving">
    <div class="movie-container">
        ...
        <ul> 
          <li class="film-pic">
            <a @click="showDetail(subject.id)">
              <img :src="subject.images.large" alt="" class="movieImg">
            </a>
          </li>
          <li class="film-name">
            <a>{{subject.title}}</a>
      ...
      <div class="load-more" @click="maxNum = data.subject.length" v-if="maxNum < data.subjects.length">
        加载更多
      </div>
    </div>
  </div>

    ...
    <div class="douban-header-container">
      <div class="douban-search">
        ...
        <div class="search-container">
          <el-input placeholder="电影、影人、影院" v-model="content">
            <el-button slot="append" icon="el-icon-search" @click="searchMovie"></el-button>
          </el-input>
        </div>
        <img class="douban-title-img" src="https://img3.doubanio.com/f/movie/9f89b66fd864158832aa65002525bb34fb029a56/pics/movie/events/annual2016/ad_web.png" alt="">
      </div>
    </div>
    <div class="douban-bar">
      <ul>
        <li v-for="(bar, index) in barList" :key="index" @click="choiceUrl(bar.title)">
